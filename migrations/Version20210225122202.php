 ...
 */
final class Version20210225122202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE open_days_store (open_days_id INT NOT NULL, store_id INT NOT NULL, INDEX IDX_2BD5ADCD5841366A (open_days_id), INDEX IDX_2BD5ADCDB092A811 (store_id), PRIMARY KEY(open_days_id, store_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE open_days_store DROP FOREIGN KEY FK_2BD5ADCD5841366A');
        $this->addSql('ALTER TABLE open_days_store DROP FOREIGN KEY FK_2BD5ADCDB092A811');
